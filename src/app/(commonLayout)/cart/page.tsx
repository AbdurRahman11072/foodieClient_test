...
export default function CartPage() {
      ...
      prevItems.map((item) =>
        item.mealId === id
          ? {
              ...
              totalPrice: (item.price as number) * newQuantity, // Update total price
            }
          : item
      )
    );
  ...
  const removeItem = (id: string) => {
    setItems((prevItems) => prevItems.filter((item) => item.mealId !== id));
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                <Card key={item.mealId} className="p-4">
                  <div className="flex gap-4">
                    <Image
                      src={item.mealImg as string}
                      alt={item.mealName as string}
                      width={300}
                      height={300}
                    ...
                    <div className="flex-1 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          onClick={() => removeItem(item.mealId as string)}
